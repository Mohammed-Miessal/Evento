...
@section('content')
    ...
    <div class="cards flex flex-wrap justify-center tablet:justify-between gap-6 mb-12">
        <div
            ...
            <div class="data_container flex justify-between">
                <div class="left">
                    ...
                    <p class="font-bold dark:text-gray-200 text-lg font-inter"> {{ $totalUsers }} </p>
                    <p class="font-medium text-[#7F7D83] font-lora">Total Users</p>
                </div>
        ...
        <div
            ...
            <div class="data_container flex justify-between">
                <div class="left">
                    <p class="font-bold dark:text-gray-200 text-lg font-inter"> {{ $totalEventsPublished }} </p>
        ...
        <div
            ...
            <div class="data_container flex justify-between">
                <div class="left">
                    <p class="font-bold dark:text-gray-200 text-lg font-inter"> {{ $totalEventsPending }} </p>
                    <p class="font-medium text-[#7F7D83] font-lora ">
        ...
        <div class="data_container flex justify-between">
            <div class="left">
                <p class="font-bold dark:text-gray-200 text-lg font-inter"> {{ $totalCategories }} </p>
                <p class="font-medium text-[#7F7D83] font-lora ">
                    Total Categories 
                </p>
            </div>
