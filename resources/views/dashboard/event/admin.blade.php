    ...
    <div class="bg-white dark:bg-gray-800 border border-[#D9D9DE] dark:border-gray-700 rounded-xl p-8 mb-12">
        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
            ...
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div
                    class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden overflow-y-visible min-h-80 ">
                                ...
                                @foreach ($events as $event)
                                    <tr class="border-b dark:border-gray-700">
                                        <td class="px-4 py-3 text-center">
                                            <img class="w-fit h-10  flex justify-center items-center "
                                                src="{{ asset('storage/' . $event->image_path) }}">
                                        </td>
                                        <td class="px-4 py-3 text-center"> {{ $event->title }} </td>
                                        <td class="px-4 py-3 text-center"> {{ $event->date }} </td>
                                        <td class="px-4 py-3 text-center"> {{ $event->location }} </td>
                                        <td class="px-4 py-3 text-center">{{ $event->categorie->name }} </td>
                                        <td class="px-4 py-3 text-center">
                                            {{-- {{ $event->status }}  --}}
                                        ...
                                        {{-- <td class="px-4 py-3 text-center  overflow-visible">
                                            <button id="event-{{ $event->id }}-Button"
                                                data-dropdown-toggle="event-{{ $event->id }}"
                                                ...
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                    ...
                                                    <li>
                                                        <a href="{{ route('event.show', $event->id) }}">
                                                            <button type="button" data-modal-target="showProductModal"
                                                                data-modal-toggle="showProductModal"
