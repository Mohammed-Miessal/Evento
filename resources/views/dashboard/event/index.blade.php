                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-center"> Title </td>
                                    <td class="px-4 py-3  text-center"> description </td>
                                    <td class="px-4 py-3 text-center"> Author </td>
                                    <td class="px-4 py-3 text-center"> Categorie </td>
                                    <td class="px-4 py-3 text-center"> Tags </td>
                                    ...
                                    <td class="px-4 py-3 text-center  overflow-visible">
                                        <button id="event-Button" data-dropdown-toggle="event" data-dropdown-placement="top"
